<x-app-layout>
    ...
    <form method="POST" action="{{ route('companies.store') }}"  enctype="multipart/form-data" class="mt-6 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"style="margin-left: 500px">
        @csrf
            <div>
